...
class Config:
    ...
    API_HASH = getenv("API_HASH", "3f779654fdd3b9278fd95869aabf4593")
    API_ID = getenv("API_ID", "17584090")
    ...
    AUTH_CHATS = getenv("AUTH_CHATS", "-1002217233160").split()
    OWNER_ID = int(getenv("OWNER_ID", 7252430326))
